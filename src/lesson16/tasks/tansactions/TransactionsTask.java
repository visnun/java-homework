...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        // Map<String, Long> numberAccountTotal = transactionStream.collect(Collectors
        ...
        Map<String, Long> first = transactionStream
                .collect(Collectors.toMap(
                        ...
                        (item1, item2) -> item1 + item2 // Long::sum
                ));
        ...
        transactionStream = Stream.of(transaction1, transaction2, transaction3,
                transaction4, transaction5, transaction6, transaction7);
        Map<Account, Long> accountAccountTotal = transactionStream.collect(Collectors
                .groupingBy(Transaction::getAccount, Collectors.summingLong(Transaction::getSum)));


        System.out.println(accountAccountTotal);
    }
}